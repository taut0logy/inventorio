        ...
        <div className="container mx-auto px-4 py-4 min-h-[calc(100vh-8rem)] flex items-center justify-center">
            <Card className="w-full max-w-md">
                ...
                <CardContent>
                    ...
                    <form method="post" action={registerPath} data-turbo="false" onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Button variant="outline" asChild>
                            <a href={googlePath} data-turbo="false" className="w-full">
                        ...
                        <Button variant="outline" asChild>
                            <a href={facebookPath} data-turbo="false" className="w-full">
